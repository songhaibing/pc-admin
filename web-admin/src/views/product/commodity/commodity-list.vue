  ...
  <div style="padding: 20px">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column align="center" prop="username" label="图片" />
        <el-table-column align="center" prop="realname" label="品名" />
        <el-table-column align="center" prop="nickname" label="类型" />
        <el-table-column align="center" prop="phone" label="定价" />
        <el-table-column align="center" prop="phone" label="可选日期" />
        <el-table-column align="center" prop="phone" label="预定时间" />
        <el-table-column align="center" prop="phone" label="好评率" />
