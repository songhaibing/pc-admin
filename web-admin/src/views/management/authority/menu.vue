<template>
  <div>
    <el-row>
      ...
      <div v-else style="padding:30px;margin-left: 200px;">
        <el-card class="box-card">
          ...
          <el-form ref="form" :model="form" status-icon :rules="rules" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="是否一直显示">
              <el-select v-model="value1" placeholder="请选择" :disabled="disabled" style="width: 100%">
                <el-option
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        this.value1 = this.singleData.alwaysShow
      }
    }
  }
</script>
