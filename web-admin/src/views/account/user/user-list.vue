          ...
          >
            ...
            <el-table-column align="center" label="操作" width="150">
              <template slot-scope="scope">
                ...
                <el-button size="mini" type="text" v-if="scope.row.state==='1'&&$_Authorities.indexOf('禁用用户')!==-1"
                           @click="disableUser(scope.$index, scope.row)">禁用
                </el-button>
                <el-button size="mini" type="text" v-if="scope.row.state==='2'&&$_Authorities.indexOf('禁用用户')!==-1"
